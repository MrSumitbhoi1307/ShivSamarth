  ...
  return (
    <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur-md">
      ...
      <div className="mx-auto flex h-16 md:h-20 max-w-7xl items-center gap-2 sm:gap-4 px-3 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSearch} className="flex-1 min-w-0 max-w-[220px] sm:max-w-xs md:max-w-md mx-1 md:mx-4">
        ...
        <div className="flex items-center gap-1 sm:gap-2 shrink-0">
          ...
          {/* HAMBURGER — mobile only, always shows remaining items */}
          <button
            type="button"
      ...
      {/* =====================================================
          MOBILE QUICK-LINKS BAR — Home / Shop / Categories
          Always visible under the main row on mobile
      ===================================================== */}
      ...
      {/* =====================================================
          HAMBURGER DRAWER (3-line menu content)
      ===================================================== */}
      {mobileMenuOpen && (
          ...
          {isAuthenticated ? (
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl mb-2">
              ...
              <div className="overflow-hidden">
                <p className="font-semibold text-sm text-gray-800 truncate">{user?.name || "User"}</p>
